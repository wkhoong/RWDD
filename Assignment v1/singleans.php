...
<html>
<head>
    <title>Create Single Answer Questions</title>
...
.clear-button:hover {
    background-color: #2e6b4f; /* Lighter green on hover */
        ...
        @media (max-width: 768px) {
            ...
            .content {
                padding: 30px 15px; /* Adjust content padding */
            }
            .content h2 {
                font-size: 20px; /* Adjust font size for smaller screens */
            }
            .progress-bar {
                width: 90%; /* Adjust progress bar width */
            }
            .container {
                padding: 30px; /* Adjust container padding */
            }
            .button {
                min-width: 100px; /* Adjust minimum width for buttons */
            }
        }

        @media (max-width: 480px) {
            .header {
                padding: 10px; /* Further adjust header padding */
            }
            .header .subject-input {
                width: 150px; /* Further adjust input width */
            }
            .content {
                padding: 20px 10px; /* Further adjust content padding */
            }
            .content h2 {
                font-size: 18px; /* Further adjust font size */
            }
            .progress-bar {
                flex-direction: column; /* Stack progress bar steps vertically */
                align-items: flex-start; /* Align items to the start */
            }
            .progress-bar .line {
                display: none; /* Hide lines for smaller screens */
            }
            .container {
                padding: 20px; /* Further adjust container padding */
            }
            .button {
                flex: 1; /* Allow buttons to take full width */
                min-width: 80px; /* Adjust minimum width for buttons */
            }
            .question-input {
                width: 100%; /* Full width for question input */
            }
            .answer-options input.answer-input {
                flex: 1 1 calc(100% - 20px); /* Full width for answer options */
            }
        }
    </style>
</head>
<body>
    ...
    <div class="content">
        ...
        <div class="container">
            <div class="button-container">
                <button class="button active">Single correct answer</button>
    ...
    <div class="answer-options">
        ...
        <label>
            <input type="radio" name="correct_answer" value="C"> Option C
        </label>
        <label>
            <input type="radio" name="correct_answer" value="D"> Option D
        </label>
    </div>
    ...
    document.querySelector('.previous-button').addEventListener('click', function() {
        if (currentQuestionIndex > 0) {
            ...
            document.querySelector(`input[name="correct_answer"][value="${previousQuestion.correct_answer}"]`).checked = true; // Check the correct answer radio button
        } else {
